...
LongUncertainty = 3*MetToDeg # This represents a 3m uncertainty in our starting long
LatUncertainty = 3*MetToDeg # This represents a 3m uncertainty in our starting lat
LatVelocityUncertainty = latVelocity/5  # setting our uncertainty of initial velocity
LongVelocityUncertainty = longVelocity/5
FilteredLongitude = []
FilteredLatitude = []
...
with open("RandomedGPS.txt") as Datafile:
    for line in Datafile:
